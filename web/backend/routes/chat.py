...
def execute_message_logic(
    ...
    if intent == "help":
        assistant_reply = (
            ...
            "- `/job-skill search [role]` — Search 18+ job platforms for roles matching your Candidate Profile. Generates tailored ATS resumes, cover letters, and live apply links.\n"
        ...
        if not assistant_reply:
            assistant_reply = (
                ...
                f"- `/job-skill search [role]` — Search 18+ platforms & find matching opportunities with direct apply links\n"
